...
class Message extends MessageInterface
{
  ...
  {
    return isset($this->headers[$this->prepareHeaderName($name)]);
  }
  ...
  public function withHeader($name, $value)
  {
    ...
    $clone->headers[$this->prepareHeaderName($name)] = (array) $value;
  ...
  public function withoutHeader($name)
  {
    ...
    unset($clone->headers[$this->prepareHeaderName($name)]);
